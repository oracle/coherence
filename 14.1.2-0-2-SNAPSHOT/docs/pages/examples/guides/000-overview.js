...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="#examples/guides/906-partition-level-transactions/README.adoc" @click.native="this.scrollFix('#examples/guides/906-partition-level-transactions/README.adoc')"><div class="card__link-hover"/>
</router-link>
<v-card-title primary class="headline layout justify-center">
