...
>mvn clean install -DskipTests -pl docs -P docs</markup>
...
>mvn exec:exec -pl docs -P docs</markup>
...
>engine:
  asciidoctor:
    ...
    attributes:
      ...
      version-commercial-docs: "14.1.2.0"
      version-helidon: "${helidon.version}"</markup>

<p>The format of an attribute is name followed by a colon, and the attribute value in quotes,
so above the value of the <code>version-commercial-docs</code> attribute is <code>14.1.2.0</code>.</p>
...
<v-card-text><p>The current commercial Coherence version is 14.1.2.0.</p>
</v-card-text>
</v-card>
