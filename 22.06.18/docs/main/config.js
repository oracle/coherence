...
function createRoutes(){
    return [
        ...
        {
            path: '/docs/core/04_serialization_hardening',
            meta: {
                h1: 'Serialization Hardening (SER-01)',
                title: 'Serialization Hardening (SER-01)',
                h1Prefix: null,
                description: null,
                keywords: null,
                customLayout: null,
            ...
            component: loadPage('docs-core-04_serialization_hardening', '/docs/core/04_serialization_hardening', {})
        },
        {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            items: [
                                ...
                                { href: '/docs/core/04_serialization_hardening', title: 'Serialization Hardening (SER-01)' },
