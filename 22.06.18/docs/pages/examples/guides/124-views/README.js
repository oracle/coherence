...
void testGreaterEqualsFilterWithChanges() {
    ...
    Country mexico = new Country("Mexico", "Ciudad de M?xico", 126.01); <span class="conum" data-value="5" />
    map.put("mx", mexico);
...
void testAggregate() {
    ...
    Country mexico = new Country("Mexico", "Ciudad de M?xico", 126.01); <span class="conum" data-value="6" />
    map.put("mx", mexico);
