...
package com.tangosol.internal.lucene.util;
...
/**
 * A variety of high efficiency bit twiddling routines and encoders for
 * primitives.
 *
 * @lucene.internal
 */
public final class BitUtil
     ...
     * Native byte order.
     *
     * <p>Warning: This constant is {@link ByteOrder#nativeOrder()} only in
     * production environments,
     * during testing we randomize it. If you need to communicate with native
     * APIs (e.g., Java's Panama API), use {@link ByteOrder#nativeOrder()}.
     */
    ...
    /**
     * A {@link VarHandle} to read/write little endian {@code short} from/to a
     * byte array. Shape: {@code short vh.get(byte[] arr, int ofs)} and
     * {@code void vh.set(byte[] arr, int ofs, short val)}
     */
    public static final VarHandle VH_LE_SHORT =
            MethodHandles.byteArrayViewVarHandle(short[].class, ByteOrder.LITTLE_ENDIAN);

    /**
     * A {@link VarHandle} to read/write little endian {@code int} from a byte
     * array. Shape: {@code int vh.get(byte[] arr, int ofs)} and
     * {@code void vh.set(byte[] arr, int ofs, int val)}
     */
    public static final VarHandle VH_LE_INT =
            MethodHandles.byteArrayViewVarHandle(int[].class, ByteOrder.LITTLE_ENDIAN);

    /**
     * A {@link VarHandle} to read/write little endian {@code long} from a byte
     * array. Shape: {@code long vh.get(byte[] arr, int ofs)} and
     * {@code void vh.set(byte[] arr, int ofs, long val)}
     */
    public static final VarHandle VH_LE_LONG =
            MethodHandles.byteArrayViewVarHandle(long[].class, ByteOrder.LITTLE_ENDIAN);

    /**
     * A {@link VarHandle} to read/write little endian {@code float} from a byte
     * array. Shape: {@code float vh.get(byte[] arr, int ofs)} and
     * {@code void vh.set(byte[] arr, int ofs, float val)}
     */
    public static final VarHandle VH_LE_FLOAT =
            MethodHandles.byteArrayViewVarHandle(float[].class, ByteOrder.LITTLE_ENDIAN);

    /**
     * A {@link VarHandle} to read/write little endian {@code double} from a
     * byte array. Shape: {@code double vh.get(byte[] arr, int ofs)} and
     * {@code void vh.set(byte[] arr, int ofs, double val)}
     */
    public static final VarHandle VH_LE_DOUBLE =
            MethodHandles.byteArrayViewVarHandle(double[].class, ByteOrder.LITTLE_ENDIAN);

    /**
     * A {@link VarHandle} to read/write native endian {@code short} from/to a
     * byte array. Shape: {@code short vh.get(byte[] arr, int ofs)} and
     * {@code void vh.set(byte[] arr, int ofs, short val)}
     *
     * <p>Warning: This handle uses default order only in production
     * environments, during testing we
     * randomize it. If you need to communicate with native APIs (e.g., Java's
    ...
    /**
     * A {@link VarHandle} to read/write native endian {@code int} from a byte
     * array. Shape: {@code int vh.get(byte[] arr, int ofs)} and
     * {@code void vh.set(byte[] arr, int ofs, int val)}
     *
     * <p>Warning: This handle uses default order only in production
    ...
    /**
     * A {@link VarHandle} to read/write native endian {@code long} from a byte
     * array. Shape: {@code long vh.get(byte[] arr, int ofs)} and
     * {@code void vh.set(byte[] arr, int ofs, long val)}
     *
     * <p>Warning: This handle uses default order only in production
    ...
    /**
     * A {@link VarHandle} to read/write native endian {@code float} from a byte
     * array. Shape: {@code float vh.get(byte[] arr, int ofs)} and
     * {@code void vh.set(byte[] arr, int ofs, float val)}
     *
     * <p>Warning: This handle uses default order only in production
    ...
    /**
     * A {@link VarHandle} to read/write native endian {@code double} from a
     * byte array. Shape: {@code double vh.get(byte[] arr, int ofs)} and
     * {@code void vh.set(byte[] arr, int ofs, double val)}
     *
     * <p>Warning: This handle uses default order only in production
    ...
    /**
     * A {@link VarHandle} to read/write big endian {@code short} from a byte
     * array. Shape: {@code short vh.get(byte[] arr, int ofs)} and
     * {@code void vh.set(byte[] arr, int ofs, short val)}
     *
     * @deprecated Better use little endian unless it is needed for backwards
     * compatibility.
     */
    @Deprecated
    ...
    /**
     * A {@link VarHandle} to read/write big endian {@code int} from a byte
     * array. Shape: {@code int vh.get(byte[] arr, int ofs)} and
     * {@code void vh.set(byte[] arr, int ofs, int val)}
     *
     * @deprecated Better use little endian unless it is needed for backwards
    ...
    /**
     * A {@link VarHandle} to read/write big endian {@code long} from a byte
     * array. Shape: {@code long vh.get(byte[] arr, int ofs)} and
     * {@code void vh.set(byte[] arr, int ofs, long val)}
     *
     * @deprecated Better use little endian unless it is needed for backwards
    ...
    /**
     * A {@link VarHandle} to read/write big endian {@code float} from a byte
     * array. Shape: {@code float vh.get(byte[] arr, int ofs)} and
     * {@code void vh.set(byte[] arr, int ofs, float val)}
     *
     * @deprecated Better use little endian unless it is needed for backwards
    ...
    /**
     * A {@link VarHandle} to read/write big endian {@code double} from a byte
     * array. Shape: {@code double vh.get(byte[] arr, int ofs)} and
     * {@code void vh.set(byte[] arr, int ofs, double val)}
     *
     * @deprecated Better use little endian unless it is needed for backwards
     * compatibility.
    ...
    /**
     * Extract just the even-bits value as a long from the bit-interleaved
     * value
     */
     ...
     * encode
     * the provided long. Assuming the input is a signed long whose absolute
     * value can be stored on
     * <code>n</code> bits, the returned value will be an unsigned long that can
     * be stored on <code>
     * n+1</code> bits.
     */
     ...
     * unsigned integer - is either 0 or a power of two.
     */
