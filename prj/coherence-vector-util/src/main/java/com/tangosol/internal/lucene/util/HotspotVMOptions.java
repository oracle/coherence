...
final class HotspotVMOptions
    ...
    /**
     * True iff the Java VM is based on Hotspot and has the Hotspot MX bean
     * readable by Lucene
     */
    public static final boolean IS_HOTSPOT_VM;

    /**
     * Returns an optional with the value of a Hotspot VM option. If the VM
     * option does not exist or is not readable, returns an empty optional.
     */
    ...
    static
        ...
        Function<String, Optional<String>> accessor = s -> Optional.empty();
        try
            {
        ...
        ReflectiveOperationException | RuntimeException e)
            {
            isHotspot = false;
