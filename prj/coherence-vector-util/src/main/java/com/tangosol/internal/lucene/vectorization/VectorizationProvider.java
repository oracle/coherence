...
package com.tangosol.internal.lucene.vectorization;

import com.tangosol.internal.lucene.util.Constants;
 ...
 * and availability of vectorization modules in the Java runtime this class
 * provides optimized implementations (using SIMD) of several algorithms used
 * throughout Apache Lucene.
 *
 * <p>Expert: set the {@value #UPPER_JAVA_FEATURE_VERSION_SYSPROP} system
...
public abstract class VectorizationProvider
    ...
    private static int getUpperJavaFeatureVersion()
        ...
        NumberFormatException | SecurityException ignored)
            {
     ...
     * possibilities of actual runtime.
     *
     * @throws UnsupportedOperationException if the singleton getter is not
     *                                       called from known Lucene classes.
     */
    ...
    /**
     * Returns a singleton (stateless) {@link VectorUtilSupport} to support SIMD
     * usage in {@link VectorUtil}.
     */
    ...
    /**
     * Looks up the vector module from Lucene's {@link ModuleLayer} or the root
     * layer (if unnamed).
     */
