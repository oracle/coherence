...
public final class SafeHashMapMemoryUsageTest
    ...
    public void testDefaultMemoryUsage()
        ...
        assertTrue("Total memory usage when increased by more than 5% to " + fullLayout.totalSize(), fullLayout.totalSize() < 95_120_256 * 1.05);
        }
    ...
    public void testMemoryUsage()
        ...
        GraphLayout fullLayout = GraphLayout.parseInstance(cache);
        assertTrue("Total memory usage when increased by more than 5% to " + fullLayout.totalSize(), fullLayout.totalSize() < 93_120_272 * 1.05);
        }
    }