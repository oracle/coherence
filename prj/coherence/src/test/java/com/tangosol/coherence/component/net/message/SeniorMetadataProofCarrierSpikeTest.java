...
public class SeniorMetadataProofCarrierSpikeTest
    ...
    public static class TestClusterService
        ...
        @Override
        public boolean isSeniorMetadataProofV1Compatible(Member member)
            {
            return m_fSenderCompatible
                    && Message.isSeniorMetadataProofV1Compatible(VersionHelper.encodeVersion(15, 1, 2, 0, 0));
            }

        @Override
        public boolean isSeniorMetadataProofV1Compatible(MemberSet setMembers)
            {
