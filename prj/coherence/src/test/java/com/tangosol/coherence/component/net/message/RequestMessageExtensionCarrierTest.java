...
public class RequestMessageExtensionCarrierTest
    ...
    private static MasterMemberSet memberSet()
        {
        MasterMemberSet setMember = new MasterMemberSet();
        int             nVersion  = VersionHelper.encodeVersion(15, 1, 2, 0, 0);
    ...
    public static class TestPartitionedCache
        ...
        static final int SUBJECT_PROOF_TYPE    = 1;
        static final int SUBJECT_PROOF_VERSION = 1;
