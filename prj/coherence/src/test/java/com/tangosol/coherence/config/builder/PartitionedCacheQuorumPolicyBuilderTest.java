...
public class PartitionedCacheQuorumPolicyBuilderTest
    ...
    public void testMinimal()
        ...
        for (PartitionedCacheQuorumPolicy.ActionRule action : PartitionedCacheQuorumPolicy.ActionRule.values())
            {
            bldr.addQuorumRule(action.getElementName(), action.getMask(), THRESHOLD_VALUE);
            }
    ...
    public void testInvalid()
        ...
        for (PartitionedCacheQuorumPolicy.ActionRule action : PartitionedCacheQuorumPolicy.ActionRule.values())
            {
            bldr.addQuorumRule(action.getElementName(), action.getMask(), INVALID_THRESHOLD_VALUE);
            }
