...
public final class PagedQueryHelper
     ...
     */
    public static Stream<BytesValue> keysPagedQuery(CacheRequestHolder<PageRequest, ?> holder, long cTransferThreshold)
        {
        try
            {
     ...
     */
    public static Stream<EntryResult> entryPagedQuery(CacheRequestHolder<PageRequest, ?> holder, long cTransferThreshold)
        {
        try
            {
