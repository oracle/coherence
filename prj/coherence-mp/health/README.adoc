...
Where `${coherence.groupId}` is the Maven groupId for the Coherence edition being used, `com.oracle.elcoherence`
for the commercial edition or `com.oracle.elcoherence.ce` for the community edition.
