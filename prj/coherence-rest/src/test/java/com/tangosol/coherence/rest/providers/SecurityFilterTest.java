...
public class SecurityFilterTest
    ...
    // ---- inner class: TestSecurityContext --------------------------------
    ...
    // ---- inner class: ThrowingAuthenticationSchemeContext ----------------
    ...
    private static class ThrowingAuthenticationSchemeContext
        ...
        public String getAuthenticationScheme()
            {
            // simulate a malformed container security context
            throw new IllegalStateException("authentication scheme unavailable");
            }
        }

    // ---- inner class: ThrowingPrincipalContext ---------------------------
    ...
    private static class ThrowingPrincipal
        ...
        public String getName()
            {
            // simulate a malformed container principal
