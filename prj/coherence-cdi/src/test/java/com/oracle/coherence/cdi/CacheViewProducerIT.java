...
class CacheViewProducerIT
    ...
    void shouldInjectCachesFromDifferentCacheFactories()
        ...
        assertThat(bean.getDefaultCcfNumbers().getCache().getCacheName(), Matchers.is("numbers"));
        ...
        assertThat(bean.getSpecificCcfNumbers().getCache().getCacheName(), Matchers.is("numbers"));
    ...
    void testCtorInjection()
        ...
        assertThat(bean.getNumbers(), is(instanceOf(ContinuousQueryCache.class)));
        assertThat(bean.getNumbers().getCache().getCacheName(), Matchers.is("numbers"));
        }
