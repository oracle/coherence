...
import static com.tangosol.util.Base.printStackTrace;
...
public abstract class Logger
    ...
    public static void setLoggingLevel(int nSeverity)
        {
        CacheFactory.log("Ignoring Logger.setLoggingLevel(" + nSeverity
                + ") because this release branch does not expose a CacheFactory logging-level setter.",
                Base.LOG_DEBUG);
        }
