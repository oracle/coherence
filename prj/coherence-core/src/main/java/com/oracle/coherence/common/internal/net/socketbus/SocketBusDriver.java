...
public class SocketBusDriver
    ...
    public static class DefaultDependencies
         ...
         */
        protected long m_cbAutoFlush = getSafeMemorySize(Config.getProperty(
                SocketBusDriver.class.getName()+".autoFlushThreshold"));

        /**
         * Threshold after which to request receipts.
         */
        protected long m_cbReceiptRequest = getSafeMemorySize(Config.getProperty(
        ...
        public static final SocketOptions DEFAULT_OPTIONS = new SocketOptions()
            ...
            final int RX_BUFFER_SIZE = (int) getSafeMemorySize(Config.getProperty(
                                        SocketBusDriver.class.getName()+".socketRxBuffer"));
            final int TX_BUFFER_SIZE = (int) getSafeMemorySize(Config.getProperty(
