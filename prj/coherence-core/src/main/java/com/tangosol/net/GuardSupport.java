...
public class GuardSupport
    ...
    */
    ...
    protected static long getLogThreaddumpIntervalMs()
        ...
        if (ldtInterval > MAX_LOG_THREADDUMP_INTERVAL_MS)
            {
            CacheFactory.log("Property \"" + PROP_LOG_THREADDUMP_INTERVAL + "\" is set to a duration that exceeds maximum " +
                        MAX_LOG_THREADDUMP_INTERVAL + " duration, adjusting to maximum value allowed.", 2);
    ...
    * @since 25.03
    */
    protected static final String DEFAULT_LOG_THREADDUMP_INTERVAL = "15m";
