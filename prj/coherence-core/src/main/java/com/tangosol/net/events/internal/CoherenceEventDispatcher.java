...
public class CoherenceEventDispatcher
    ...
    public void dispatchStarting()
        {
        dispatchCacheEvent(CoherenceLifecycleEvent.Type.STARTING);
        }

    public void dispatchStarted()
        {
        dispatchCacheEvent(CoherenceLifecycleEvent.Type.STARTED);
        }

    public void dispatchStopping()
        {
        dispatchCacheEvent(CoherenceLifecycleEvent.Type.STOPPING);
        }

    public void dispatchStopped()
        {
        dispatchCacheEvent(CoherenceLifecycleEvent.Type.STOPPED);
        }
     ...
     */
    protected void dispatchCacheEvent(CoherenceLifecycleEvent.Type eventType)
        {
