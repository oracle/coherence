...
public class PartitionSizeAggregator<K, V>
    ...
    public boolean accumulate(InvocableMap.Entry<? extends K, ? extends V> entry)
        {
        BinaryEntry<? extends K, ? extends V> binEntry    = (BinaryEntry) entry;
    ...
    public SortedSet<PartitionSize> finalizeResult()
        {
        SortedSet<PartitionSize> result = new TreeSet<>(Remote.comparator((Remote.Comparator<PartitionSize>) (p1, p2) -> Integer.compare(p1.getPartitionId(), p2.getPartitionId())));
