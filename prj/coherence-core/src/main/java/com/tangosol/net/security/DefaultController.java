    ...
    private Set getAuthorizingPrincipals(Subject subject)
        ...
        if (verified != null && verified.getSubject() == subject)
            ...
            if (!subject.getPrincipals().contains(principal))
                {
                throw new AccessControlException("Verified signing principal is not present in the subject");
                }
        ...
        if (!setCerts.isEmpty())
            ...
            throw new AccessControlException("Subject contains principals not bound to a verified certificate");
            }
