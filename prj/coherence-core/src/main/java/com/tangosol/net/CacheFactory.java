...
public abstract class CacheFactory
    ...
    *
    * @return XmlElement representing the federation configuration
    */
    ...
    /**
    * Set the federation configuration.  If the Cluster service is
    * already running, this call will not have any effect.
    *
    * @param xmlCfg  an XmlElement representing the federation configuration
    */
    public static void setFederationConfig(XmlElement xmlCfg)
        {
        setServiceConfig("$Federation", xmlCfg);
        }
