...
public interface AsyncNamedCache<K, V>
     ...
     *         key is mapped
     */
    public default CompletableFuture<V> get(K key)
        {
     ...
     */
    public default CompletableFuture<Map<K, V>> getAll(Collection<? extends K> colKeys)
        {
     ...
     */
    public default CompletableFuture<Void> getAll(Collection<? extends K> colKeys,
     ...
     */
    public default CompletableFuture<Void> put(K key, V value)
        {
     ...
     * @return a {@link CompletableFuture}
     */
    public default CompletableFuture<Void> putAll(Map<? extends K, ? extends V> map)
        {
     ...
     *         with the <tt>key</tt>
     */
    public default CompletableFuture<V> remove(K key)
        {
     ...
     * @return a {@link CompletableFuture}
     */
    public default CompletableFuture<Void> removeAll(Collection<? extends K> colKeys)
        {
     ...
     */
    public default CompletableFuture<Set<K>> keySet()
        {
     ...
     *         the operation completed
     */
    public default CompletableFuture<Void> keySet(Consumer<? super K> callback)
        {
     ...
     */
    public default CompletableFuture<Set<Map.Entry<K, V>>> entrySet()
        {
     ...
     *         the operation completed
     */
    public default CompletableFuture<Void> entrySet(BiConsumer<? super K, ? super V> callback)
        {
     ...
     *         the operation completed
     */
    public default CompletableFuture<Void> entrySet(Consumer<? super Map.Entry<? extends K, ? extends V>> callback)
        {
        return entrySet(AlwaysFilter.INSTANCE, callback);
        }
    ...
    /**
      ...
      */
     public default CompletableFuture<Collection<V>> values()
         {
   ...
   /**
     ...
     *         the operation completed
     */
    public default CompletableFuture<Void> values(Consumer<? super V> callback)
        {
     ...
     */
    public default <R> CompletableFuture<Map<K, R>> invokeAll(InvocableMap.EntryProcessor<K, V, R> processor)
        {
     ...
     */
    public default <R> CompletableFuture<Void> invokeAll(InvocableMap.EntryProcessor<K, V, R> processor,
     ...
     *         operation completed successfully
     */
    public default <R> CompletableFuture<Void> invokeAll(Collection<? extends K> collKeys,
     ...
     *         of the aggregation
     */
    public default <R> CompletableFuture<R> aggregate(InvocableMap.EntryAggregator<? super K, ? super V, R> aggregator)
        {
     ...
     *         of the aggregation
     */
    public <R> CompletableFuture<R> aggregate(Collection<? extends K> collKeys,
    ...
    public default CompletableFuture<V> getOrDefault(K key, V valueDefault)
        {
     ...
     */
    public default CompletableFuture<V> putIfAbsent(K key, V value)
        {
     ...
     */
    public default CompletableFuture<Boolean> remove(K key, V value)
        {
     ...
     *         if the implementation supports null values.)
     */
    public default CompletableFuture<V> replace(K key, V value)
        {
     ...
     */
    public default CompletableFuture<Boolean> replace(K key, V oldValue, V newValue)
        {
     ...
     */
    public default CompletableFuture<V> computeIfAbsent(
     ...
     */
    public default CompletableFuture<V> computeIfPresent(
     ...
     * @return the new value associated with the specified key, or null if none
     */
    public default CompletableFuture<V> compute(K key,
     ...
     */
    public default CompletableFuture<V> merge(K key, V value,
     ...
     */
    public default CompletableFuture<Map<K, Void>> replaceAll(
     ...
     * @param function the function to apply to each entry
     */
    public default CompletableFuture<Map<K, Void>> replaceAll(Collection<? extends K> collKeys,
            Remote.BiFunction<? super K, ? super V, ? extends V> function)
        {
