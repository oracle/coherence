...
public class X509PeerProofProvider
    ...
    /** Wipe a credential password after use. */
    private static void resetPassword(char[] password)
        {
        if (password != null)
            {
    ...
    private static final Set<String> OID_PKCS12_PBE = immutableSet("1.2.840.113549.1.12.1.1",
            "1.2.840.113549.1.12.1.2", "1.2.840.113549.1.12.1.3",
            "1.2.840.113549.1.12.1.4", "1.2.840.113549.1.12.1.5",
            "1.2.840.113549.1.12.1.6");
    private static final Set<String> OID_HMAC = immutableSet("1.2.840.113549.2.7",
            "1.2.840.113549.2.8", "1.2.840.113549.2.9", "1.2.840.113549.2.10",
            "1.2.840.113549.2.11");
    private static final Map<String, Integer> OID_AES_CBC = immutableIntMap(
            "2.16.840.1.101.3.4.1.2", 16,
            "2.16.840.1.101.3.4.1.42", 32);
    private static final Map<String, Integer> OID_MAC_DIGEST = immutableIntMap(
    ...
    private static Map<String, Integer> immutableIntMap(Object... values)
        {
