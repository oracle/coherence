...
/**
 * An exponentially-decaying random reservoir of {@code long}s. Uses Cormode et al's forward-decaying priority reservoir
 * sampling method to produce a statistically representative sampling reservoir, exponentially biased towards newer
 * entries.
 *
 * @see <a href="http://dimacs.rutgers.edu/~graham/pubs/papers/fwddecay.pdf">
 * Cormode et al. Forward Decay: A Practical Time Decay Model for Streaming Systems. ICDE '09: Proceedings of the 2009
 * IEEE International Conference on Data Engineering (2009)</a>
 */
class ExponentiallyDecayingReservoir
    {
    /**
     * Creates a new {@link ExponentiallyDecayingReservoir} of 1028 elements, which offers a 99.9% confidence level with
     * a 5% margin of error assuming a normal distribution, and an alpha factor of 0.015, which heavily biases the
     ...
     * @param alpha the exponential decay factor; the higher this is, the more biased the reservoir will be towards
     *              newer values
     */
