 ...
 * mean of an int-valued function applied to the input elements.
 *
 ...
 * @since 12.2.1
 */
public class AveragingIntCollector<T>
     ...
     */
    public AveragingIntCollector(Remote.ToIntFunction<? super T> mapper)
        {
        m_mapper = mapper;
        }
