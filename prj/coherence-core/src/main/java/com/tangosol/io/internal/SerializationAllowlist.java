...
public final class SerializationAllowlist
    ...
    private static Class<?> validateRestGeneratedPartialClass(MethodHandles.Lookup lookup, Class<?> clz)
        ...
        // rest-01-14.1.1.2206-backport-plan.md: Java 11 lacks Lookup.hasFullPrivilegeAccess;
        // private access is the strongest caller proof available on this release line
