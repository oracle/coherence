    ...
    */
    public static class VersionAwareBufferInput
        ...
        */
        ...
        /**
        * Determine whether the sender's encoded version satisfies the
        * specified compatibility predicate.
        *
        * @param predicate  the compatibility predicate
        *
        * @return true iff the sender's encoded version satisfies the
        *         specified predicate
        */
        public boolean isVersionCompatible(IntPredicate predicate)
            {
            return f_message.isSenderCompatible(predicate);
            }
