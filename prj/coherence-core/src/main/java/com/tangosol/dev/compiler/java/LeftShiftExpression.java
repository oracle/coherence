...
public class LeftShiftExpression extends ShiftExpression
    ...
    /**
    * Construct a LeftShiftExpression.
    *
    * @param left      the left expression
    * @param operator  the operator token
    * @param right     the right expression
    */
    public LeftShiftExpression(Expression left, Token operator, Expression right)
        {
    ...
    * The class name.
    */
    private static final String CLASS = "LeftShiftExpression";
    }
