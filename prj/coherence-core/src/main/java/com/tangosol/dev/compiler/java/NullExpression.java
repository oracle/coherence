...
/**
* Implements a null literal expression.
*
...
public class NullExpression extends LiteralExpression
    ...
    /**
    * Construct a NullExpression.
    *
    * @param block    the containing block
    * @param literal  the literal token
    */
    public NullExpression(Block block, Token literal)
        {
        super(block, literal);
        }
    ...
    * The class name.
    */
    private static final String CLASS = "NullExpression";
    }
