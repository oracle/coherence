...
/**
* Implements a float literal expression.
*
...
public class FloatExpression extends LiteralExpression
    ...
    /**
    * Construct a FloatExpression.
    *
    * @param block    the containing block
    * @param literal  the literal token
    */
    public FloatExpression(Block block, Token literal)
        {
        super(block, literal);
        }
    ...
    */
    protected boolean compile(Context ctx, CodeAttribute code, boolean fReached, ErrorList errlist)
            throws CompilerException
        {
        code.add(new Fconst(((LiteralToken) getEndToken()).floatValue()));
    ...
    * The class name.
    */
    private static final String CLASS = "FloatExpression";
    }
