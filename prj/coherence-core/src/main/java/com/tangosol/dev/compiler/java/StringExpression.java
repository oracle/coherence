...
/**
* Implements a string literal expression.
*
...
public class StringExpression extends LiteralExpression
    ...
    /**
    * Construct a StringExpression.
    *
    * @param block    the containing block
    * @param literal  the literal token
    */
    public StringExpression(Block block, Token literal)
        {
        super(block, literal);
        }
    ...
    */
    protected boolean compile(Context ctx, CodeAttribute code, boolean fReached, ErrorList errlist)
            throws CompilerException
        {
        code.add(new Aconst((String) getEndToken().getValue()));
    ...
    * The class name.
    */
    private static final String CLASS = "StringExpression";
    }
