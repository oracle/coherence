...
/**
* Implements a double literal expression.
*
...
public class DoubleExpression extends LiteralExpression
    ...
    /**
    * Construct a DoubleExpression.
    *
    * @param block    the containing block
    * @param literal  the literal token
    */
    public DoubleExpression(Block block, Token literal)
        {
        super(block, literal);
        }
    ...
    */
    protected boolean compile(Context ctx, CodeAttribute code, boolean fReached, ErrorList errlist)
            throws CompilerException
        {
        code.add(new Dconst(((LiteralToken) getEndToken()).doubleValue()));
    ...
    * The class name.
    */
    private static final String CLASS = "DoubleExpression";
    }
