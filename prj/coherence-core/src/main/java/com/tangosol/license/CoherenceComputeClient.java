...
*/
public class CoherenceComputeClient
        extends CoherenceCachingEdition
    {
    /**
    ...
    */
    static public void printLicense()
        {
        printLicense(CoherenceComputeClient.class, NAME);
        }

    /**
    * The product name.
    */
    private static final String NAME = CacheFactory.PRODUCT + ": Compute Client";
    }
