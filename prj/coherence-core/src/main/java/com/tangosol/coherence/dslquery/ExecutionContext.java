...
public class ExecutionContext
    ...
    /**
     * The current {@link ContainerContext} being used if QueryPlus
     * has been started with both the -g argument to load a GAR file and
     * the -tenants argument to set a list of tenants.
     */
    protected ContainerContext m_containerContext;
