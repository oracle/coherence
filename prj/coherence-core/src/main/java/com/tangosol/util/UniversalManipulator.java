...
/**
 * Universal {@link ValueManipulator} implementation.
 * <p>
 * Backported for REST-01 so the 14.1.1.2206 REST processor aliases can use the
 * core Universal extractor/updater path instead of legacy REST MVEL
 * manipulators; see rest-01-14.1.1.2206-backport-plan.md.
 *
 * @author Vaso Putica  2026.05.18
 * @since 14.1.1.2206.18
 */
public class UniversalManipulator
    ...
    /**
     * Construct a UniversalManipulator based on a
     * {@link UniversalExtractor#createExtractor(String) UniversalExtractor}
     * name expression.
     *
    ...
    /**
     * Compare the UniversalManipulator with another object to determine
     * equality.
     *
     * @return true iff this UniversalManipulator and the passed object are
     *         equivalent UniversalManipulators
     */
    ...
    /**
     * Determine a hash value for the UniversalManipulator object according to
    ...
    /**
     * The {@link UniversalExtractor#createExtractor(String) UniversalExtractor}
