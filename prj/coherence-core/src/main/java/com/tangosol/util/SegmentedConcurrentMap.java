        ...
        public Object invokeFound(Object oKey,
            ...
            if (lockHolder != null && lockHolder instanceof Thread)
                ...
                try
                    ...
                    thread.interrupt();
                    CacheFactory.log("TruncateAction: interrupted lock holder thread: " + thread.getName() + " holding lock on key: " + entry.getKey() +
                                " LockableEntry@" + Integer.toHexString(System.identityHashCode(entry)), Base.LOG_DEBUG);
        ...
        public Object invokeFound(Object oKey,
            ...
            if (lockHolder != null && lockHolder instanceof Thread)
                ...
                try
                    ...
                    CacheFactory.log("SegmentedConcurrentMap.dump: " + "LockableEntry@" + Integer.toHexString(System.identityHashCode(entry)) +
