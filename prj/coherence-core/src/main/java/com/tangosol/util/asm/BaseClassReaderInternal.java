...
public abstract class BaseClassReaderInternal<RT, CVT>
     ...
     *
     * @param streamIn  the stream to read
     *
     * @return the stream bytes
     *
     * @throws IOException if an I/O error occurs
     */
    protected static byte[] readAllBytes(InputStream streamIn)
            throws IOException
        {
     ...
     */
    private static final int MAX_MAJOR_VERSION = 57;  // Opcodes.V13
