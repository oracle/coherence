...
public class InvocableMapTest
    ...
    public void testInvokeAllWithKeySet()
        ...
        assertEquals(expected, map.invokeAll(Arrays.asList("1", "3"), InvocableMapTest::square));
        }
    ...
    public void testInvokeAllWithFilter()
        ...
        assertEquals(expected, map.invokeAll(GREATER_THAN_1, InvocableMapTest::square));
        }
