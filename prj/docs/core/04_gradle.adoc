...
a `23.09` version, yet. Instead, please use the `23.03` version of the plugin. A new plugin version with full `Java 21`
support should be available with Coherence `23.09.1` or `24.03`. However, the plugin can be used with `Java 21` projects.
====
