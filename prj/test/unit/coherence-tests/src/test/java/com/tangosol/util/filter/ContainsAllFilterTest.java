...
/**
* ContainsAllFilter unit tests
*
* @author tb 2010.2.08
*/
@RunWith(value = Parameterized.class)
public class ContainsAllFilterTest
    {

    public ContainsAllFilterTest(boolean fOrdered, boolean fPartial)
        {
        m_fOrdered = fOrdered;
        m_fPartial = fPartial;
        }
    ...
    */
    ...
    public void testApplyIndex()
        ...
        // create the ContainsAllFilter to be tested
        IndexAwareFilter filter = new ContainsAllFilter(IdentityExtractor.INSTANCE, new HashSet(Arrays.asList(3,2)));
