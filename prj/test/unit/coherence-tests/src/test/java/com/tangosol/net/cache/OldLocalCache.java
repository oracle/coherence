...
/**
* A OldLocalCache implementation that supports the JCache API, CacheLoader and
* CacheStore objects.
*
* @since Coherence 2.2
*
...
public class OldLocalCache
    ...
    */
    public OldLocalCache(int cUnits)
        {
    ...
    */
    public OldLocalCache(int cUnits, int cExpiryMillis)
        {
    ...
    */
    public OldLocalCache(int cUnits, int cExpiryMillis, CacheLoader loader)
        {
    ...
    */
    public synchronized Object remove(Object oKey)
        ...
        OldOldCache.Entry entry = (OldOldCache.Entry) getEntryInternal(oKey);
        if (entry == null)
            {
            return null;
            }
    ...
    /**
    * Determine the loader used by this OldLocalCache, if any.
    *
    * @return the loader used by this OldLocalCache, or null if none
    */
    ...
    /**
    * Specify the loader used by this OldLocalCache.
    *
    ...
    */
    ...
    /**
    * Determine the store used by this OldLocalCache, if any.
    *
    * @return the CacheStore used by this OldLocalCache, or null if none
    */
    ...
    */
    protected synchronized void removeExpired(OldOldCache.Entry entry, boolean fRemoveInternal)
        {
        KeyMask mask  = getKeyMask();
        boolean fPrev = mask.ensureSynthetic();
        try
            {
            super.removeExpired(entry, fRemoveInternal);
            }
        finally
            {
