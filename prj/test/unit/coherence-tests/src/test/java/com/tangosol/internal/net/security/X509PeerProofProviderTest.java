...
public class X509PeerProofProviderTest
    ...
    public void shouldDeriveDistinctSubjectAndPerServiceSeniorPopulationsAndBindTheirEpochs() throws Exception
        ...
        assertEquals(new java.util.LinkedHashSet<>(members.subList(0, 2)),
                topology.producers(PeerProofReadiness.Role.SUBJECT));
        assertEquals(Collections.singleton(members.get(1)),
                topology.recipients(PeerProofReadiness.Role.SUBJECT));
        assertEquals(new java.util.LinkedHashSet<>(Arrays.asList(members.get(1), members.get(3))),
        ...
        assertEquals(2, subject.getProducerCount());
        assertEquals(1, subject.getRecipientCount());
        ...
        assertEquals(2, senior.getProducerCount());
