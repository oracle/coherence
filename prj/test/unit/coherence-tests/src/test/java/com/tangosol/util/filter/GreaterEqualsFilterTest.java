...
/**
* GreaterEqualsFilter unit tests
*
* @author tb 2010.2.08
*/
@SuppressWarnings({"unchecked", "rawtypes"})
@RunWith(value = Parameterized.class)
public class GreaterEqualsFilterTest
    {
    public GreaterEqualsFilterTest(boolean fOrdered, boolean fPartial)
        {
        m_fOrdered = fOrdered;
        m_fPartial = fPartial;
        }
    ...
    */
    ...
    public void testApplyIndex()
        ...
        // create the GreaterEqualsFilter to be tested
        IndexAwareFilter filter = new GreaterEqualsFilter(IdentityExtractor.INSTANCE, 3);
        ...
        assertEquals("Unexpected number of keys after applyIndex.", 3, setKeys.size());
