...
public class DaemonPoolSizingComponentTest
    ...
    public void shouldDeriveProxyPipelineAndWorkerDefaultsFromAvailableProcessors()
        ...
        assertThat(tcp.getConnectionPipelineCount(), is(0));
        ...
        assertThat(((TcpAcceptorDependencies) virtual.getAcceptorDependencies())
                .getConnectionPipelineCount(), is(0));
    ...
    public void shouldGrowProxyDecodeLanesWithoutReplacingExistingOwners()
        ...
        try
            ...
            assertThat(aThree[0], sameInstance(aOne[0]));
            assertThat(aTwo[0], sameInstance(aOne[0]));
            assertThat(aTwo[1], sameInstance(aThree[1]));
            assertThat(aTwo[2], sameInstance(aThree[2]));
            }
        finally
            {
