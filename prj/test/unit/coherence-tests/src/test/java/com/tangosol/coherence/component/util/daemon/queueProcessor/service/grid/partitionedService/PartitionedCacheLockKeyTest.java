...
public class PartitionedCacheLockKeyTest
    ...
    public void shouldReleasePhysicalLockWhenStatusRegistrationThrows()
        ...
        TestPartitionedCache         service     = new TestPartitionedCache(coordinator);
        Storage                      storage     = new Storage(null, null, false);
    ...
    private static class TestPartitionedCache
        ...
        {
        TestPartitionedCache(ResourceCoordinator coordinator)
            {
        ...
        private final ResourceCoordinator m_coordinator;
    ...
    private static class ContentionResourceCoordinator
        ...
        @Override
        public void onContend(Thread thread, ConcurrentKeyLock.LockState state)
            {
            m_latchContention.countDown();
            }

        @Override
        public void onUncontend(Thread thread, ConcurrentKeyLock.LockState state)
            {
            }
