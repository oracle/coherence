...
public class JmxmpServerTest
    ...
    public static class SmokeAuthenticator
        ...
        private static boolean containsOk(Object credentials)
            ...
            if (credentials instanceof Object[] aoCredentials)
                {
    ...
    private record TestFilterInfo(Class<?> serialClass, long arrayLength, long depth, long references, long streamBytes)
