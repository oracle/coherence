...
public class ExtendClientQueueTests<QueueType extends NamedQueue>
    ...
    @RegisterExtension
    static final TestLogsExtension m_logs = new TestLogsExtension(ExtendClientQueueTests.class);
