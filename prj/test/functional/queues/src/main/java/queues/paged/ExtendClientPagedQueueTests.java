...
public class ExtendClientPagedQueueTests<QueueType extends NamedQueue>
    ...
    @RegisterExtension
    static final TestLogsExtension m_logs = new TestLogsExtension(ExtendClientPagedQueueTests.class);
