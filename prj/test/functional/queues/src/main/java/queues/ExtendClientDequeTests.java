...
public class ExtendClientDequeTests<QueueType extends NamedDeque>
    ...
    public void shouldBeRemoteClient()
        ...
        assertThat(service, is(instanceOf(RemoteCacheService.class)));
        }

    // ----- data members ---------------------------------------------------

    public static final String CLUSTER_NAME = "ExtendClientDequeTests";

    protected static Coherence m_coherence;

    @RegisterExtension
    static final TestLogsExtension m_logs = new TestLogsExtension(ExtendClientDequeTests.class);
