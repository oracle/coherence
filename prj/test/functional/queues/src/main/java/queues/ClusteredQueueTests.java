...
public class ClusteredQueueTests<QueueType extends NamedQueue>
    ...
    public static final String CLUSTER_NAME = "ClusteredQueueTests";

    private static Session m_session;

    @RegisterExtension
    static final TestLogsExtension m_logs = new TestLogsExtension(ClusteredQueueTests.class);
