...
/**
 * Tests queues from a gRPC client where the client uses the JSON serializer.
 */
@SuppressWarnings({"rawtypes", "resource"})
public class GrpcClientJsonDequeTests<QueueType extends NamedDeque>
    ...
    static void setup() throws Exception
        ...
        System.setProperty("coherence.serializer",  "json");
    ...
    @RegisterExtension
    static final TestLogsExtension m_logs = new TestLogsExtension(GrpcClientJsonDequeTests.class);
