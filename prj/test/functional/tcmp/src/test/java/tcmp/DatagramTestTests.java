...
public class DatagramTestTests
    ...
    public void setupTest()
        ...
        CacheFactory.log("Setting rxBufferSize to " + m_nBufferSize + " and packetSize to " + m_nPacketSize +
                         " based on MTU=" + nMTU + " and ReceiveBufferSize=" + nRecvBufferSize, CacheFactory.LOG_INFO);
        ...
        try (CapturingApplicationConsole console1     = new CapturingApplicationConsole();
            ...
            try
                ...
                if (application1 != null)
                    ...
                    CacheFactory.log("First 200 lines console1:", CacheFactory.LOG_INFO);
                ...
                if (application2 != null)
                    ...
                    CacheFactory.log("First 200 lines console2:", CacheFactory.LOG_INFO);
