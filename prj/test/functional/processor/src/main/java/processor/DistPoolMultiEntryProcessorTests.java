...
public class DistPoolMultiEntryProcessorTests
    ...
    */
    ...
    public static void startup()
        {
        CoherenceClusterMember member1 = startCacheServer("DistPoolMultiProcessorTests-1", "processor");
        CoherenceClusterMember member2 = startCacheServer("DistPoolMultiProcessorTests-2", "processor");
