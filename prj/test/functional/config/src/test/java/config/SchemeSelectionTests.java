...
public class SchemeSelectionTests
    ...
    */
    ...
    @Test
    public void externalAsyncNioMemory() throws Exception
        {
        NamedCache cache = validateNamedCache("external-async-nio-memory", CacheService.TYPE_LOCAL);
        assertTrue(cache instanceof SafeNamedCache);
        TestHelper.validateBackingMapType(cache, SerializationMap.class);
        releaseNamedCache(cache);
        }
    ...
    @Test
    public void externalNioMemory() throws Exception
        {
        NamedCache cache = validateNamedCache("external-nio-memory", CacheService.TYPE_LOCAL);
        assertTrue(cache instanceof SafeNamedCache);
        TestHelper.validateBackingMapType(cache, SerializationMap.class);
        releaseNamedCache(cache);
        }
    ...
    @Test
    public void pagedExternalAsyncNioMemory() throws Exception
        {
        NamedCache cache = validateNamedCache("paged-external-async-nio-memory", CacheService.TYPE_LOCAL);
        assertTrue(cache instanceof SafeNamedCache);
        TestHelper.validateBackingMapType(cache, SerializationPagedCache.class);
        releaseNamedCache(cache);
        }
    ...
    @Test
    public void pagedExternalNioMemory() throws Exception
        {
        NamedCache cache = validateNamedCache("paged-external-nio-memory", CacheService.TYPE_LOCAL);
        assertTrue(cache instanceof SafeNamedCache);
        TestHelper.validateBackingMapType(cache, SerializationPagedCache.class);
        releaseNamedCache(cache);
        }
