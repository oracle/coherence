...
public class OptionalDeserializationTest
    ...
    public void setup()
        ...
        System.setProperty("coherence.wka", LocalPlatform.get().getLoopbackAddress().getHostAddress());
    ...
    private static final MyResultClassLoader appLoader = new MyResultClassLoader();
