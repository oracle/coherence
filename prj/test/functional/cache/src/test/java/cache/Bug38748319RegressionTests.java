...
import com.tangosol.coherence.component.util.daemon.queueProcessor.service.grid.partitionedService.PartitionedCache$MapEvent;
...
public class Bug38748319RegressionTests
    ...
    public final CoherenceClusterResource s_cluster =
            new CoherenceClusterResource()
                    .with(ClusterName.of(Bug38748319RegressionTests.class.getSimpleName() + "-" + System.nanoTime()),
