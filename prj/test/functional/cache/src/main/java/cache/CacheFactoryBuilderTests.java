...
public class CacheFactoryBuilderTests
    ...
    */
    ...
    public static final String CACHE_CFG_TRANS_TEST     = "<cache-config>"
    + "  <caching-scheme-mapping>"
    + "    <cache-mapping>"
    ...
    + "<scheme-name>example-transactional</scheme-name>"
    + "<scheme-ref>test-transactional</scheme-ref>"
    ...
    + "</transactional-scheme>"
    + "<transactional-scheme>"
    + "<scheme-name>test-transactional</scheme-name>"
    + "<service-name>TransactionalCache</service-name>"
    + "<thread-count>7</thread-count>"
    + "<high-units>{txn-storage-limit 15M}</high-units>"
