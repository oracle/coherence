...
public class ClusteredRemoteReadWriteLockExtendIT
        extends AbstractClusteredRemoteReadWriteLockExtendIT
    {
    // ----- constructors ---------------------------------------------------

    public ClusteredRemoteReadWriteLockExtendIT()
        {
     ...
     */
    static TestLogs logs = new TestLogs(ClusteredRemoteReadWriteLockExtendIT.class);
