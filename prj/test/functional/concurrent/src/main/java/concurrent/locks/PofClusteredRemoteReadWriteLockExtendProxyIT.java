...
public class PofClusteredRemoteReadWriteLockExtendProxyIT
        extends AbstractClusteredRemoteReadWriteLockExtendProxyIT
    {
    // ----- constructors ---------------------------------------------------

    public PofClusteredRemoteReadWriteLockExtendProxyIT()
        {
     ...
     */
    static TestLogs logs = new TestLogs(PofClusteredRemoteReadWriteLockExtendProxyIT.class);
