...
public class PofClusteredRemoteSemaphoreExtendIT
     ...
     * Default constructor.
     */
    public PofClusteredRemoteSemaphoreExtendIT()
        {
     ...
     */
    static TestLogs logs = new TestLogs(PofClusteredRemoteSemaphoreExtendIT.class);

    /**
     * A Bedrock JUnit5 extension that starts a Coherence cluster made up of
     * three storage enabled members, three Extend proxy servers and three
     * Extend clients.
     */
    @RegisterExtension
