...
public class PofClusteredRemoteReadWriteLockExtendIT
        extends AbstractClusteredRemoteReadWriteLockExtendIT
    {
    // ----- constructors ---------------------------------------------------

    public PofClusteredRemoteReadWriteLockExtendIT()
        {
     ...
     */
    static TestLogs logs = new TestLogs(PofClusteredRemoteReadWriteLockExtendIT.class);
