...
/**
 * Test distributed locks across multiple Extend cluster members using the default
 * Java serializer.
 */
public class ClusteredRemoteLockExtendProxyIT
        extends AbstractClusteredRemoteLockExtendProxyIT
    {
    // ----- constructors ---------------------------------------------------

    public ClusteredRemoteLockExtendProxyIT()
        {
     ...
     */
    static TestLogs logs = new TestLogs(ClusteredRemoteLockExtendProxyIT.class);

    /**
     * A Bedrock JUnit5 extension that starts a Coherence cluster made up of
     * three storage enabled members that act as Extend proxies and three
     * Extend cliends.
     */
    @RegisterExtension
