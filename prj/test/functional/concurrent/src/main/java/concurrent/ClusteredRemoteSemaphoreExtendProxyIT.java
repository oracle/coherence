...
public class ClusteredRemoteSemaphoreExtendProxyIT
     ...
     * Default constructor.
     */
    public ClusteredRemoteSemaphoreExtendProxyIT()
        {
     ...
     */
    static TestLogs logs = new TestLogs(ClusteredRemoteSemaphoreExtendProxyIT.class);

    /**
     * A Bedrock JUnit5 extension that starts a Coherence cluster made up of
     * three storage enabled members that acts as Extend proxies,
     * and three Extend clients.
     */
    @RegisterExtension
