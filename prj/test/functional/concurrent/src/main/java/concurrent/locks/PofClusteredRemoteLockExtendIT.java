...
/**
 * Test distributed locks across multiple Extend cluster members using POF serializer.
 */
public class PofClusteredRemoteLockExtendIT
        extends AbstractClusteredRemoteLockExtendIT
    {
    // ----- constructors ---------------------------------------------------

    public PofClusteredRemoteLockExtendIT()
        {
    ...
    private static final String CLUSTER_NAME = PofClusteredRemoteLockExtendIT.class.getSimpleName()
     ...
     */
    static TestLogs logs = new TestLogs(PofClusteredRemoteLockExtendIT.class);

    /**
     * A Bedrock JUnit5 extension that starts a Coherence cluster made up of
     * three storage enabled members, three Extend proxies and three
     * Extend clients.
     */
    @RegisterExtension
