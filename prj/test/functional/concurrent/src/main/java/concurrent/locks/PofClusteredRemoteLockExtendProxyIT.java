 ...
 */
public class PofClusteredRemoteLockExtendProxyIT
        extends AbstractClusteredRemoteLockExtendProxyIT
    {
    // ----- constructors ---------------------------------------------------

    public PofClusteredRemoteLockExtendProxyIT()
        {
     ...
     */
    static TestLogs logs = new TestLogs(PofClusteredRemoteLockExtendProxyIT.class);

    /**
     * A Bedrock JUnit5 extension that starts a Coherence cluster made up of
     * three storage enabled members acting as Extend proxies and three
     * Extend clients.
     */
    @RegisterExtension
