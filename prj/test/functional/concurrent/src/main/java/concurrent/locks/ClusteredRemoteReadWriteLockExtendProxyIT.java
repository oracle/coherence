...
public class ClusteredRemoteReadWriteLockExtendProxyIT
        extends AbstractClusteredRemoteReadWriteLockExtendProxyIT
    {
    // ----- constructors ---------------------------------------------------

    public ClusteredRemoteReadWriteLockExtendProxyIT()
        {
     ...
     */
    static TestLogs logs = new TestLogs(ClusteredRemoteReadWriteLockExtendProxyIT.class);
