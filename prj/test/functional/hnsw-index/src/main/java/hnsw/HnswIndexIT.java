...
public class HnswIndexIT
    ...
    static void setup() throws Exception
        ...
        vectors.addIndex(new HnswIndex<>(ValueExtractor.of(ValueWithVector::getVector), DIMENSIONS));
    ...
    public void shouldSearch()
        ...
        System.out.println("HNSW took " + (endTimeHnsw - startTimeHnsw) + " ns");
