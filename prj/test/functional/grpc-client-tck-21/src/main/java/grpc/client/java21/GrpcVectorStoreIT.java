...
public class GrpcVectorStoreIT
    ...
    static void startCoherence() throws Exception
        ...
        Coherence.client(Coherence.Mode.Grpc).start().get(5, TimeUnit.MINUTES);
        }
    ...
    public void shouldBeRemoteStore()
        ...
        assertThat(service, is(instanceOf(GrpcRemoteService.class)));
        }
    ...
    @RegisterExtension
    static final TestLogsExtension TEST_LOGS = new TestLogsExtension(GrpcVectorStoreIT.class);
