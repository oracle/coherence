...
public class JpaCacheStoreWithIdClassTest
    ...
    public void setUp()
        ...
        {
        super.setUp();
        m_loader = new JpaCacheLoader(ENTITY_PERSON_ID_CLASS,
                ENTITY_CLASS_NAME, PERSISTENCE_UNIT);
        m_store = new JpaCacheStore(ENTITY_PERSON_ID_CLASS,
                ENTITY_CLASS_NAME, PERSISTENCE_UNIT);
        }
    ...
    public static String ENTITY_CLASS_NAME = "data.persistence.CompoundPerson1";
    }