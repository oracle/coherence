...
public class ClusterSimilaritySearchPofIT
    ...
    static final String CLUSTER_NAME = "ClusterSimilaritySearchPofIT";

    static final int CLUSTER_SIZE = 3;

    @RegisterExtension
    static final TestLogsExtension TEST_LOGS = new TestLogsExtension(ClusterSimilaritySearchPofIT.class);
