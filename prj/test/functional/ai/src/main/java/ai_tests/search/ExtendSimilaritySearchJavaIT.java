...
public class ExtendSimilaritySearchJavaIT
    ...
    static final String CLUSTER_NAME = "ExtendSimilaritySearchJavaIT";

    static final int CLUSTER_SIZE = 3;

    @RegisterExtension
    static final TestLogsExtension TEST_LOGS = new TestLogsExtension(ExtendSimilaritySearchJavaIT.class);
