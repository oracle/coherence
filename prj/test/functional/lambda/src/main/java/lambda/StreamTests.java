...
public class StreamTests
    ...
    public StreamTests(SessionBuilder bldrSession, String sSerializer, boolean fParallel)
        {
        super(fParallel);
    ...
    protected InvocableMap<String, Person> getPeopleMap()
        ...
        InvocableMap<String, Person> map = cacheFactory.<String, Person>ensureTypedCache(
                m_sSerializer,
                null,
                withoutTypeChecking());
        map.clear();
