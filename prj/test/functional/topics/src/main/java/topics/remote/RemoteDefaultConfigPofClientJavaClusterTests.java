...
/**
 * Validate topics over Extend with the client using POF and the cluster using Java.
 */
public class RemoteDefaultConfigPofClientJavaClusterTests
        extends AbstractNamedTopicTests
    {
    // ----- constructors ---------------------------------------------------

    public RemoteDefaultConfigPofClientJavaClusterTests()
        {
        super("pof", true);
        }
    ...
    @ClassRule
    public static TestLogs s_testLogs = new TestLogs(RemoteDefaultConfigPofClientJavaClusterTests.class);
