...
/**
 * Validate topics over Extend with the server using POF payload using default coherence-cache-config.
 */
public class RemoteDefaultConfigPofClientPofClusterTests
        extends AbstractNamedTopicTests
    {
    // ----- constructors ---------------------------------------------------

    public RemoteDefaultConfigPofClientPofClusterTests()
        {
        super("pof");
        }
    ...
    @ClassRule
    public static TestLogs s_testLogs = new TestLogs(RemoteDefaultConfigPofClientPofClusterTests.class);
    ...
    private static String getClusterName()
        ...
        if (sCluster == null)
            {
            return RemoteDefaultConfigPofClientPofClusterTests.class.getSimpleName() + "Cluster";
            }

        String sSuffix    = "-RD-PCPC";
