...
/**
 * Validate topics over Extend with the server using Java serializer using default coherence-cache-config.
 */
public class RemoteDefaultConfigJavaClientJavaClusterTests
        extends AbstractNamedTopicTests
    {
    // ----- constructors ---------------------------------------------------

    public RemoteDefaultConfigJavaClientJavaClusterTests()
        {
        super("java");
        }
    ...
    @ClassRule
    public static TestLogs s_testLogs = new TestLogs(RemoteDefaultConfigJavaClientJavaClusterTests.class);
    ...
    private static String getClusterName()
        ...
        if (sCluster == null)
            {
            return RemoteDefaultConfigJavaClientJavaClusterTests.class.getSimpleName() + "Cluster";
            }

        String sSuffix    = "-RD-JCJC";
