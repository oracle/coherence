...
public class TopicSubscriberManagementTests
    ...
    public void shouldGetChannelAllocations()
        ...
        try (PagedTopicSubscriber<String> subscriberOne = (PagedTopicSubscriber<String>) topic.createSubscriber(inGroup(sGroupOne));
             PagedTopicSubscriber<String> subscriberTwo = (PagedTopicSubscriber<String>) topic.createSubscriber(inGroup(sGroupOne));
             PagedTopicSubscriber<String> subscriberThree = (PagedTopicSubscriber<String>) topic.createSubscriber(inGroup(sGroupTwo)))
            {
    ...
    @Test
        public void shouldDisconnectSingleSubscriberByKey() throws Exception
            ...
            try (PagedTopicSubscriber<String> subscriberOne = (PagedTopicSubscriber<String>) topic.createSubscriber(inGroup(sGroupOne));
                ...
                Eventually.assertDeferred(subscriberOne::isDisconnected, is(true));
                assertThat(subscriberTwo.isDisconnected(), is(false));
                assertThat(subscriberThree.isDisconnected(), is(false));
        ...
        public void shouldDisconnectAllSubscribersInGroup() throws Exception
            ...
            try (PagedTopicSubscriber<String> subscriberOne = (PagedTopicSubscriber<String>) topic.createSubscriber(inGroup(sGroupOne));
                ...
                Eventually.assertDeferred(subscriberOne::isDisconnected, is(true));
                Eventually.assertDeferred(subscriberTwo::isDisconnected, is(true));
                assertThat(subscriberThree.isDisconnected(), is(false));
        ...
        public void shouldDisconnectAllSubscribers() throws Exception
            ...
            try (PagedTopicSubscriber<String> subscriberOne = (PagedTopicSubscriber<String>) topic.createSubscriber(inGroup(sGroupOne));
                ...
                Eventually.assertDeferred(subscriberOne::isDisconnected, is(true));
                Eventually.assertDeferred(subscriberTwo::isDisconnected, is(true));
                Eventually.assertDeferred(subscriberThree::isDisconnected, is(true));
    ...
    public void shouldDisconnectSubscribersOnSpecificMember()
        ...
        try (CoherenceClusterMember member    = platform.launch(CoherenceClusterMember.class,
            ...
            try (PagedTopicSubscriber<String> subscriberOne = (PagedTopicSubscriber<String>) topic.createSubscriber(inGroup(sGroupOne));
                 PagedTopicSubscriber<String> subscriberTwo = (PagedTopicSubscriber<String>) topic.createSubscriber(inGroup(sGroupTwo)))
                {
                Eventually.assertDeferred(() -> subscriberOne.getChannels().length, is(greaterThan(0)));
                Eventually.assertDeferred(() -> subscriberTwo.getChannels().length, is(greaterThan(0)));
