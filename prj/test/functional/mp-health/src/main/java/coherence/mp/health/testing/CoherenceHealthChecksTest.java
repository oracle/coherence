...
public class CoherenceHealthChecksTest
    {
    @Test
    public void shouldNotBeStartedIfNullCoherenceInstances()
        {
        Supplier<Collection<Coherence>> supplier    = () -> null;
        CoherenceHealthChecks           checks      = new CoherenceHealthChecks(supplier);
        HealthCheck                     healthCheck = checks.startup();
        assertDown(healthCheck, CoherenceHealthChecks.HEALTH_CHECK_STARTUP);
        }

    @Test
    public void shouldNotBeStartedIfEmptyCoherenceInstances()
        {
    ...
    @Test
    public void shouldNotBeStartedIfNoCoherenceHealthChecks()
        {
        ...
        HealthCheck                     healthCheck           = coherenceHealthChecks.startup();
    ...
    public void shouldBeStarted()
        ...
        when(checkOne.isStarted()).thenReturn(true);
        when(checkTwo.getName()).thenReturn("Two");
        when(checkTwo.isStarted()).thenReturn(true);
        when(coherence.getManagement()).thenReturn(management);
        ...
        assertUp(healthCheck, CoherenceHealthChecks.HEALTH_CHECK_STARTUP);
        }

    @Test
    public void shouldNotBeStartedIfCoherenceHealthCheckDown()
        {
        Coherence                     coherence  = mock(Coherence.class);
        Registry                      management = mock(Registry.class);
        com.tangosol.util.HealthCheck checkOne   = mock(com.tangosol.util.HealthCheck.class);
        ...
        when(checkOne.isStarted()).thenReturn(true);
        when(checkTwo.getName()).thenReturn("Two");
        when(checkTwo.isStarted()).thenReturn(false);
        when(coherence.getManagement()).thenReturn(management);
        when(management.getHealthChecks()).thenReturn(checks);
