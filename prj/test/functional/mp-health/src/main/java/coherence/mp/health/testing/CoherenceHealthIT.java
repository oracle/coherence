...
public class CoherenceHealthIT
    ...
    public void shouldBeStarted() throws Exception
        {
        Eventually.assertDeferred(this::coherenceStarted, is(true));
        URI uri = URI.create("http://127.0.0.1:7001/health/started");
        assertResponse(uri, CoherenceHealthChecks.HEALTH_CHECK_STARTUP);
        }
