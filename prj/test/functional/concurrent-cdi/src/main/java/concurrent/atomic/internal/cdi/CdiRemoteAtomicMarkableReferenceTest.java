...
/**
 * {@link RemoteAtomicMarkableReference} CDI tests.
 * 
 * @author Aleks Seovic  2020.12.09
 */
@ExtendWith(WeldJunit5Extension.class)
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
public class CdiRemoteAtomicMarkableReferenceTest
    ...
    NamedMap<String, java.util.concurrent.atomic.AtomicMarkableReference<String>> refs;
