 ...
 */
public class PutDistTest
        extends AbstractPerformanceTests
    {
    // ----- constructors ---------------------------------------------------

    public PutDistTest(String description, PsrPerformanceEnvironment environment)
        {
    ...
    public void shouldRunPutsTest() throws Exception
        ...
        TestResult result = submitTest("PutDistTest", putMessage.withIterationCount(25));
