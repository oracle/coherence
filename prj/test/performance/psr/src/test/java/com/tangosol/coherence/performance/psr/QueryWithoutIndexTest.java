 ...
 */
public class QueryWithoutIndexTest
        extends AbstractPerformanceTests
    {
    // ----- constructors ---------------------------------------------------

    public QueryWithoutIndexTest(String description, PsrPerformanceEnvironment environment)
        {
    ...
    public void shouldRunQueryTest() throws Exception
        ...
        TestResult result = submitTest("QueryWithoutIndexTest", queryMessage.withIterationCount(cIterations));
