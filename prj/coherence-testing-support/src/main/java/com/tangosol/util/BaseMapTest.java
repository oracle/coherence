...
public class BaseMapTest
    ...
    public static void testSerializable(Map map)
        ...
        if (map instanceof Serializable)
            ...
            try
                ...
                ObjectInputStream inObj = ExternalizableHelper.newFilteredObjectInputStream(inRaw, null);
    ...
    * works.
    *
    * @param map  the Map to test cloning on
    */
    ...
    */
    public static BinaryStoreManager instantiateTestBinaryStoreManager()
        {
        return new DirectStoreManager(100 * 1000, 25 * 1000 * 1000);
        }
