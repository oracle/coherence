...
abstract class BaseNamedCacheClientIT
    ...
    public BaseNamedCacheClientIT(ServerHelper serverHelper)
        {
        this(serverHelper, Requests.DEFAULT_SCOPE);
        }
...
// ----- test methods ---------------------------------------------------
    ...
    void shouldDestroyCache(String sSerializerName, Serializer serializer)
        ...
        MatcherAssert.assertThat(service.isDestroyed(), is(true));
        MatcherAssert.assertThat(service.isReleased(), is(cache.isReleased()));
        MatcherAssert.assertThat(service.isActive(), is(false));
    ...
    void shouldReleaseCache(String sSerializerName, Serializer serializer)
        ...
        MatcherAssert.assertThat(service.isReleased(), is(true));
        MatcherAssert.assertThat(service.isDestroyed(), is(false));
        MatcherAssert.assertThat(service.isActive(), is(false));
    ...
    protected <K, V> NamedCache<K, V> ensureCache(String sName, ClassLoader loader)
        {
        return f_serverHelper.getCCF().ensureCache(sName, loader);
        }
