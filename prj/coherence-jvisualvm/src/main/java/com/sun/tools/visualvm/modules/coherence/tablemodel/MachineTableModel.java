...
/**
 * A model for holding machine data.
 *
 * @author tam  2013.11.14
 * @since  12.1.3
 */
public class MachineTableModel
     ...
     */
    public MachineTableModel(String[] asColumns)
        {
        super(asColumns);
        }
    ...
    private static final long serialVersionUID = -6125789271854300336L;
    }
