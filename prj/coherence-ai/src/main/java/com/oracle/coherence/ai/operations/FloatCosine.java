...
/**
 * A base {@link com.oracle.coherence.ai.VectorOp} that executes a Cosine
 * similarity algorithm against a vector of floats.
 */
public abstract class FloatCosine
        extends BaseVectorOp<Float>
    {
    /**
     * Default constructor for serialization
     */
    protected FloatCosine()
        {
        }

    /**
     * Create a {@link FloatCosine} to find similarities between
    ...
    public static final String ID = "float-cosine";
