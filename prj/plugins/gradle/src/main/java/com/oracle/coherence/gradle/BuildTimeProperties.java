...
public class BuildTimeProperties
    ...
    public BuildTimeProperties()
        ...
        try (InputStream is = BuildTimeProperties.class.getResourceAsStream(PROPERTIES_FILE_NAME))
            {
     ...
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(BuildTimeProperties.class);
