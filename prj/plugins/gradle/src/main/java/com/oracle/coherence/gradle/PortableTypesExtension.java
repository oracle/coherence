 ...
 * @since 22.06.05
 */
public abstract class PortableTypesExtension
    {
    //----- constructors ----------------------------------------------------

    /**
     * Default constructor for the PortableTypesExtension.
     */
    public PortableTypesExtension()
        {
        }

        //----- PortableTypesExtension methods --------------------------------------
    ...
    /**
     * If {@link PortableTypesExtension#getUsePofSchemaXml} is true, then use the path specified by this property to determine
