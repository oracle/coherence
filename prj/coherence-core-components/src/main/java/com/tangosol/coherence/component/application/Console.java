...
// ---- class: com.tangosol.coherence.component.application.Console

package com.tangosol.coherence.component.application;

/**
 * This Component represents a java based client application.
 * 
 * A typical use of this component would be:
 * 
 * 1) Create a component so that you could run a java client to test a portion
 * of your application you are developing.
 * 2) A "business-to-business" client.
 * 
 * The Console component is the design root for all Java based clients.
 */
...
public class Console
    ...
    public Console(String sName, com.tangosol.coherence.Component compParent, boolean fInit)
        {
    ...
    public void __init()
        ...
        if (__singleton != null)
            {
            throw new IllegalStateException("A singleton for \"Console\" has already been set");
            }
        __singleton = this;
    ...
    * @see Component#_Reference
    ...
    public static com.tangosol.coherence.Component get_Instance()
        ...
        if (singleton == null)
            {
            singleton = new com.tangosol.coherence.component.application.Console();
            }
        else if (!(singleton instanceof com.tangosol.coherence.component.application.Console))
            {
            throw new IllegalStateException("A singleton for \"com.tangosol.coherence.component.application.Console\" has already been set to a different type");
            }
        return singleton;
        }
    ...
    * given component.
    ...
    public static Class get_CLASS()
        ...
        try
            {
            clz = Class.forName("com.tangosol.coherence/component/application/Console".replace('/', '.'));
            }
