...
// ---- class: com.tangosol.coherence.component.util.deltaMap.transactionMap.pessimistic.Commited
...
public class Commited
    ...
    * Auto generated
    ...
    public static com.tangosol.coherence.Component get_Instance()
        {
        return new com.tangosol.coherence.component.util.deltaMap.transactionMap.pessimistic.Commited();
        }
    ...
    * given component.
    ...
    public static Class get_CLASS()
        ...
        try
            {
            clz = Class.forName("com.tangosol.coherence/component/util/deltaMap/transactionMap/pessimistic/Commited".replace('/', '.'));
            }
