...
public abstract class Peer
    ...
    * to true when the Service has actually "finished starting".
    ...
    public void onServiceStarted()
        ...
        com.tangosol.coherence.component.util.DaemonPool pool = getDaemonPool();
        if (pool instanceof Service.VirtualDaemonPool || pool.getDaemonCount() > 0)
            {
    ...
    * stop().
    ...
    protected com.tangosol.coherence.component.util.DaemonPool instantiateDaemonPool(boolean fVirtual)
        {
        return fVirtual
               ? new Peer.VirtualDaemonPool("VirtualDaemonPool", this, true)
               : new Peer.DaemonPool("DaemonPool", this, true);
        }

    // ---- class: com.tangosol.coherence.component.util.daemon.queueProcessor.service.Peer$VirtualDaemonPool

    /**
     * Peer-specific virtual-thread worker pool that preserves the message
     * receive path used by the platform worker pool.
     */
    @SuppressWarnings({"deprecation", "rawtypes", "unused", "unchecked", "ConstantConditions", "DuplicatedCode", "ForLoopReplaceableByForEach", "IfCanBeSwitch", "RedundantArrayCreation", "RedundantSuppression", "SameParameterValue", "TryFinallyCanBeTryWithResources", "TryWithIdenticalCatches", "UnnecessaryBoxing", "UnnecessaryUnboxing", "UnusedAssignment"})
    public static class VirtualDaemonPool
        ...
        public static com.tangosol.coherence.Component get_Instance()
            {
            return new com.tangosol.coherence.component.util.daemon.queueProcessor.service.Peer.VirtualDaemonPool();
            }
        ...
        public static Class get_CLASS()
            ...
            try
                {
                clz = Class.forName("com/tangosol/coherence/component/util/daemon/queueProcessor/service/Peer$VirtualDaemonPool".replace('/', '.'));
                }
            catch (ClassNotFoundException e)
                {
                throw new NoClassDefFoundError(e.getMessage());
