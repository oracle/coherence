...
// ---- class: com.tangosol.coherence.component.util.safeService.SafeProxyService
...
public class SafeProxyService
    ...
    // Default constructor
    public SafeProxyService()
        {
        this(null, null, true);
        }
    
    // Initializing constructor
    public SafeProxyService(String sName, com.tangosol.coherence.Component compParent, boolean fInit)
        {
    ...
    * Auto generated
    ...
    public static com.tangosol.coherence.Component get_Instance()
        {
        return new com.tangosol.coherence.component.util.safeService.SafeProxyService();
        }
    ...
    * given component.
    ...
    public static Class get_CLASS()
        ...
        try
            {
            clz = Class.forName("com.tangosol.coherence/component/util/safeService/SafeProxyService".replace('/', '.'));
            }
    ...
    * behavior.
    ...
    //++ com.tangosol.net.ProxyService integration
    // Access optimization
