...
// ---- class: com.tangosol.coherence.component.util.deltaMap.transactionMap.pessimistic.Repeatable
...
public class Repeatable
    ...
    * Auto generated
    ...
    public static com.tangosol.coherence.Component get_Instance()
        {
        return new com.tangosol.coherence.component.util.deltaMap.transactionMap.pessimistic.Repeatable();
        }
    ...
    * given component.
    ...
    public static Class get_CLASS()
        ...
        try
            {
            clz = Class.forName("com.tangosol.coherence/component/util/deltaMap/transactionMap/pessimistic/Repeatable".replace('/', '.'));
            }
