...
// ---- class: com.tangosol.coherence.component.application.library.Generic
...
public abstract class Generic
        extends    com.tangosol.coherence.component.application.Library
    {
    // ---- Fields declarations ----
    
    // Initializing constructor
    public Generic(String sName, com.tangosol.coherence.Component compParent, boolean fInit)
        {
    ...
    * @see Component#_Reference
    ...
    public static com.tangosol.coherence.Component get_Instance()
        ...
        if (!(singleton instanceof com.tangosol.coherence.component.application.library.Generic))
            {
    ...
    * given component.
    ...
    public static Class get_CLASS()
        ...
        try
            {
            clz = Class.forName("com.tangosol.coherence/component/application/library/Generic".replace('/', '.'));
            }
