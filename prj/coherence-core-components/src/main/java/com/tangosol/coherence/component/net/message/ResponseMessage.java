...
// ---- class: com.tangosol.coherence.component.net.message.ResponseMessage
...
/**
 * ResponseMessage is a Message component used to respond to generic request
 * messages.
 */
...
public class ResponseMessage
    ...
    public ResponseMessage(String sName, com.tangosol.coherence.Component compParent, boolean fInit)
        {
    ...
    * Auto generated
    ...
    public static com.tangosol.coherence.Component get_Instance()
        {
        return new com.tangosol.coherence.component.net.message.ResponseMessage();
        }
    ...
    * given component.
    ...
    public static Class get_CLASS()
        ...
        try
            {
            clz = Class.forName("com.tangosol.coherence/component/net/message/ResponseMessage".replace('/', '.'));
            }
    ...
    * the "find the data" Message.
    ...
    public final void onReceived()
        {
        // all response processing must be done through the poll
        }
