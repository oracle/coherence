...
// ---- class: com.tangosol.coherence.component.application.library.generic.CoherenceAdapter
...
public abstract class CoherenceAdapter
        extends    com.tangosol.coherence.component.application.library.Generic
    {
    // ---- Fields declarations ----
    
    // Initializing constructor
    public CoherenceAdapter(String sName, com.tangosol.coherence.Component compParent, boolean fInit)
        {
    ...
    * @see Component#_Reference
    ...
    public static com.tangosol.coherence.Component get_Instance()
        ...
        if (!(singleton instanceof com.tangosol.coherence.component.application.library.generic.CoherenceAdapter))
            {
            throw new IllegalStateException("A singleton for \"com.tangosol.coherence.component.application.library.generic.CoherenceAdapter\" has already been set to a different type");
            }
        return singleton;
        }
    ...
    * given component.
    ...
    public static Class get_CLASS()
        ...
        try
            {
            clz = Class.forName("com.tangosol.coherence/component/application/library/generic/CoherenceAdapter".replace('/', '.'));
            }
