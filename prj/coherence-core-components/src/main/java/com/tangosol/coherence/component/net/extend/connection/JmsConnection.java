...
public class JmsConnection
     ...
     */
    private jakarta.jms.Queue __m_QueueIn;
     ...
     * @see #getQueueSender
     */
    private jakarta.jms.Queue __m_QueueOut;
    ...
    * @see #getQueueReceiver
     */
    public jakarta.jms.Queue getQueueIn()
        {
        return __m_QueueIn;
        }
    ...
    * @see #getQueueSender
     */
    public jakarta.jms.Queue getQueueOut()
        {
        return __m_QueueOut;
        }
    ...
    * @see #getQueueReceiver
     */
    public void setQueueIn(jakarta.jms.Queue queue)
        {
        _assert(!isOpen());
    ...
    * @see #getQueueSender
     */
    public void setQueueOut(jakarta.jms.Queue queue)
        {
        _assert(!isOpen());
    ...
    * @see #getQueueIn
     */
    public void setQueueReceiver(jakarta.jms.QueueReceiver receiver)
        {
    ...
    * @see #getQueueOut
     */
    public void setQueueSender(jakarta.jms.QueueSender sender)
        {
    ...
    * The QueueSession wrapped by this JmsConnection.
     */
    public void setQueueSession(jakarta.jms.QueueSession session)
        {
        _assert(!isOpen());
