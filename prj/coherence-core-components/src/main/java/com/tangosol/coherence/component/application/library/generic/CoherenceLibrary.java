...
// ---- class: com.tangosol.coherence.component.application.library.generic.CoherenceLibrary

package com.tangosol.coherence.component.application.library.generic;

@SuppressWarnings({"deprecation", "rawtypes", "unused", "unchecked", "ConstantConditions", "DuplicatedCode", "ForLoopReplaceableByForEach", "IfCanBeSwitch", "RedundantArrayCreation", "RedundantSuppression", "SameParameterValue", "TryFinallyCanBeTryWithResources", "TryWithIdenticalCatches", "UnnecessaryBoxing", "UnnecessaryUnboxing", "UnusedAssignment"})
public abstract class CoherenceLibrary
        extends    com.tangosol.coherence.component.application.library.Generic
    {
    // ---- Fields declarations ----
    
    // Initializing constructor
    public CoherenceLibrary(String sName, com.tangosol.coherence.Component compParent, boolean fInit)
        {
    ...
    * @see Component#_Reference
    ...
    public static com.tangosol.coherence.Component get_Instance()
        ...
        if (!(singleton instanceof com.tangosol.coherence.component.application.library.generic.CoherenceLibrary))
            {
            throw new IllegalStateException("A singleton for \"com.tangosol.coherence.component.application.library.generic.CoherenceLibrary\" has already been set to a different type");
            }
        return singleton;
        }
    ...
    * given component.
    ...
    public static Class get_CLASS()
        ...
        try
            {
            clz = Class.forName("com.tangosol.coherence/component/application/library/generic/CoherenceLibrary".replace('/', '.'));
            }
