...
// ---- class: com.tangosol.coherence.component.application.DefaultApplication
...
public class DefaultApplication
    ...
    public DefaultApplication(String sName, com.tangosol.coherence.Component compParent, boolean fInit)
        {
    ...
    * @see Component#_Reference
    ...
    public static com.tangosol.coherence.Component get_Instance()
        ...
        if (singleton == null)
            {
            singleton = new com.tangosol.coherence.component.application.DefaultApplication();
            }
        else if (!(singleton instanceof com.tangosol.coherence.component.application.DefaultApplication))
            {
