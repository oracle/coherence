...
// ---- class: com.tangosol.coherence.component.net.extend.protocol.NameServiceProtocol
...
public class NameServiceProtocol
     ...
     * Property Instance
     *
     * The singleton NameService Protocol instance.
     */
    private static NameServiceProtocol __s_Instance;
    ...
    static
        ...
        setInstance(new NameServiceProtocol());
        }
    
    // Default constructor
    public NameServiceProtocol()
        {
        this(null, null, true);
        }
    
    // Initializing constructor
    public NameServiceProtocol(String sName, com.tangosol.coherence.Component compParent, boolean fInit)
        {
    ...
    * Auto generated
    ...
    public static com.tangosol.coherence.Component get_Instance()
        {
        return new com.tangosol.coherence.component.net.extend.protocol.NameServiceProtocol();
        }
    ...
    * given component.
    ...
    public static Class get_CLASS()
        ...
        try
            {
            clz = Class.forName("com.tangosol.coherence/component/net/extend/protocol/NameServiceProtocol".replace('/', '.'));
            }
    ...
    * The singleton NameService Protocol instance.
     */
    public static NameServiceProtocol getInstance()
        {
        return __s_Instance;
        }
    ...
    * @return a new MessageFactory for the given version of this Protocol
    ...
    protected com.tangosol.coherence.component.net.extend.MessageFactory instantiateMessageFactory(int nVersion)
        {
        // import Component.Net.Extend.MessageFactory.NameServiceFactory;
    ...
    * The singleton NameService Protocol instance.
     */
    protected static void setInstance(NameServiceProtocol protocol)
        {
