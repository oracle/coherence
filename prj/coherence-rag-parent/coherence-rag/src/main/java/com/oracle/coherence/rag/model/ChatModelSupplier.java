...
/**
 * CDI supplier for chat models in the Coherence RAG framework.
 * <p/>
 * This supplier extends {@link AbstractModelSupplier} to provide chat model
 ...
 *   <li>Configuration property: {@code coherence.rag.chat.model}</li>
 ...
 * 
 * // Get specific model
 * ChatModel specificModel = chatModelSupplier.get("oci/meta.llama-3.1-70b-instruct");
 * </pre>
 * 
 ...
 */
@ApplicationScoped
public class ChatModelSupplier
        extends AbstractModelSupplier<ChatModel>
    {
    /**
     ...
     */
    public ChatModel create(ModelName modelName)
        {
        ...
        return provider.getChatModel(modelName.name());
        }
    }
