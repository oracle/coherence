...
[CARD]
.Archiver
[link=examples/tutorials/210-archiver/README.adoc]
--
This tutorial shows you how to use a custom Persistence archiver that uses SFTP to store and retrieve snapshots.
--
