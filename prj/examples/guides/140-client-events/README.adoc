...
* https://docs.oracle.com/en/middleware/standalone/coherence/14.1.1.0/develop-applications/using-map-events.html[Develop Applications using Map Events]
* https://docs.oracle.com/en/middleware/standalone/coherence/14.1.1.0/develop-applications/introduction-coherence-caches.html[Understanding Near Caches]
* https://docs.oracle.com/en/middleware/standalone/coherence/14.1.1.0/develop-applications/using-continuous-query-caching.html[Using Continuous Query Caches]
...
<3> Update event chaging cusstomer type from GOLD to BRONZE for customer id 2
