...
/**
 * This is a copy of the Coherence {@link com.tangosol.security.KeystoreLogin} class
 * with a fix to use a certificate's subject DN as the principal name and not the
