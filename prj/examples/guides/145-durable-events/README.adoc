...
Please see <<docs/core/06_durable_events.adoc, Durable Events Documentation>> for more information on Durable Events.

NOTE: Durable events are an experimental feature only and should not be used in product as yet.
...
* <<docs/core/06_durable_events.adoc, Durable Events Overview>>
