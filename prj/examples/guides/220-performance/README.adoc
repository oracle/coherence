...
Running Tests
####
Cache Type          10k Puts    80 PutAll    1k Invoke      20k Get    1k GetAll
base                 6,168ms      2,199ms      1,199ms      8,715ms        607ms
base-rl              5,908ms      1,958ms      1,227ms      6,058ms        721ms
async-backup         5,248ms      1,045ms      1,014ms      8,314ms        789ms
sched-backup         4,516ms        946ms        873ms     10,403ms        613ms
no-backup            4,646ms        780ms        661ms      7,898ms        640ms
####
...
<2> Read locator set to `closest` means data could be read from backup or primary which could be on the same machine. As all the members are running on the same machine, the results if this test may not be relevant.
