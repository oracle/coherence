...
class NameServiceTests {
    ...
    void testNameServiceUseCase() {
        ...
        System.setProperty("tangosol.coherence.cluster", "myCluster"); // <2>
        CoherenceHelper.startCoherenceClient(CoherenceHelper.NAME_SERVICE_INSTANCE_NAME, "name-service/client-coherence-cache-config.xml"); // <3>
