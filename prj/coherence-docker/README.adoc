...
So, if the version in the `pom.xml` is `14.1.1.0.1-SNAPSHOT` the image produced will be
`oraclecoherence/coherence-ce:14.1.1.0.1`
...
The example above would build an image named `foo/coherence:14.1.1.0.1`
...
[source,bash]
----
docker run -d -P oraclecoherence/coherence-ce:14.1.1.0.1
----
...
[source,bash]
----
docker run -d -P -v /home/oracle/test-args:/args oraclecoherence/coherence-ce:14.1.1.0.1
----
...
[source,bash]
----
docker run -d -P -v /dev/my-app/lib:/coherence/ext/lib oraclecoherence/coherence-ce:14.1.1.0.1
----
...
[source,bash]
----
docker run -d -P -v /dev/my-app/classes:/coherence/ext/conf oraclecoherence/coherence-ce:14.1.1.0.1
----
