...
class NettyCredentialsHelperTest
    ...
    void shouldCreateOptionalCleartextCredentials()
        {
        assertInstanceOf(InsecureServerCredentials.class, NettyCredentialsHelper.createServerCredentials(null));
        assertInstanceOf(InsecureChannelCredentials.class, NettyCredentialsHelper.createChannelCredentials(null));
        }

    @Test
    void shouldCreateExplicitInsecureCredentials()
        {
        assertInstanceOf(InsecureServerCredentials.class, NettyCredentialsHelper.createServerCredentials(grpcInsecureBuilder()));
        assertInstanceOf(InsecureChannelCredentials.class, NettyCredentialsHelper.createChannelCredentials(grpcInsecureBuilder()));
        }
    ...
    void shouldRejectRequiredCleartext()
        ...
        IllegalStateException e = assertThrows(IllegalStateException.class,
                () -> NettyCredentialsHelper.createServerCredentials(null, GrpcTransportSecurity.SECURE_TRANSPORT_REQUIRED));
    ...
    void shouldRejectRequiredGrpcInsecure()
        {
        IllegalStateException e = assertThrows(IllegalStateException.class,
                () -> NettyCredentialsHelper.createChannelCredentials(
    ...
    void shouldRejectMissingSslDependencies()
        {
        IllegalStateException e = assertThrows(IllegalStateException.class,
                () -> NettyCredentialsHelper.createServerCredentials(missingSslBuilder()));
    ...
    void shouldCreateSslCredentials()
            throws Exception
        {
        SocketProviderBuilder builder = tlsBuilder();

        assertNotNull(NettyCredentialsHelper.createServerCredentials(
                builder, GrpcTransportSecurity.SECURE_TRANSPORT_REQUIRED));
        assertNotNull(NettyCredentialsHelper.createChannelCredentials(
                builder, GrpcTransportSecurity.SECURE_TRANSPORT_REQUIRED));
        }
