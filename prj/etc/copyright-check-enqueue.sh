...
CMD="java -cp ${JAR} org.glassfish.copyright.Copyright -c -X ${EXCLUDE} -C ${BASEDIR}/header.txt -A ${BASEDIR}/header-2.txt -A ${BASEDIR}/header-3.txt -A ${BASEDIR}/header-7.txt -A ${BASEDIR}/header-8.txt -A ${BASEDIR}/header-9.txt -q -p4 -noP4fstat $DEV_ROOT/${1}"
