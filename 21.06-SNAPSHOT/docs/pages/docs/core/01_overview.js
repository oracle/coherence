...
<div class="section">
<p>Coherence has a number of core improvements documented in this section.</p>
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/docs/core/02_bootstrap"><div class="card__link-hover"/>
</router-link>
...
<span style="text-align:center">Bootstrap API</span>
</v-card-title>
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/docs/core/03_parallel_recovery"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
...
<v-card-title primary class="headline layout justify-center">
<span style="text-align:center">Parallel Recovery</span>
</v-card-title>
<v-card-text class="caption">
<p></p>
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/docs/core/05_repository"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
...
<v-card-title primary class="headline layout justify-center">
<span style="text-align:center">Repository API</span>
</v-card-title>
<v-card-text class="caption">
<p></p>
<p>Higher level, DDD-friendly data access API.</p>
</v-card-text>
</v-card>
</v-flex>
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/docs/core/06_durable_events"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
<v-icon class="xxx-large">fa-backward</v-icon>
</v-avatar>
</v-layout>
<div class="px-3">
<v-divider class="indigo lighten-4"/>
