...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/docs/about/04_important"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
...
<v-card-title primary class="headline layout justify-center">
<span style="text-align:center">Important Changes</span>
</v-card-title>
<v-card-text class="caption">
<p></p>
<p>Important changes in this release of Coherence.</p>
</v-card-text>
</v-card>
</v-flex>
<v-flex xs12 sm4 lg3>
...
<v-flex xs12 sm4 lg3>
<v-card>
<a id="" title="" target="_blank" href="https://docs.oracle.com/en/middleware/standalone/coherence/14.1.2/index.html"><div class="card__link-hover"/>
</a>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="#docs/about/05_api.adoc" @click.native="this.scrollFix('#docs/about/05_api.adoc')"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
