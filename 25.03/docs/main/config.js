...
function createRoutes(){
    return [
        ...
        {
            path: '/docs/core/10_filter_descriptions',
            meta: {
                h1: 'Query and Trace Recorder Improvements',
                title: 'Query and Trace Recorder Improvements',
                h1Prefix: null,
                description: 'Coherence Core Improvements',
                keywords: 'coherence, java, documentation',
                customLayout: null,
            ...
            component: loadPage('docs-core-10_filter_descriptions', '/docs/core/10_filter_descriptions', {})
        },
        {
        ...
        {
            path: '/examples/guides/300-vector-store/README',
            meta: {
                h1: 'Vector DB and Knn Search',
                title: 'Vector DB and Knn Search',
                h1Prefix: null,
                description: 'Coherence Guides',
            ...
            component: loadPage('examples-guides-300-vector-store-README', '/examples/guides/300-vector-store/README', {})
        },
        {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            items: [
                                ...
                                { href: '/docs/core/02_topics', title: 'Topics' },
                                { href: '/docs/core/06_virtual_threads', title: 'Virtual Threads Support' },
                                { href: '/docs/core/08_vector_db', title: 'Vector DB' },
                                { href: '/docs/core/10_filter_descriptions', title: 'Query and Trace Recorder Improvements' }
                            ]
                        },
                        {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            items: [
                                ...
                                { href: '/examples/guides/300-vector-store/README', title: 'Vector DB and Knn Search' },
