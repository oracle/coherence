...
<tr>
<td class="">Coherence MP Metrics</td>
<td class="">Coherence Microprofile metrics, exposed on port <code>7001</code></td>
</tr>
<tr>
...
<tr>
<td class="">Helidon</td>
<td class="">The image contains the Helidon Microprofile web-server and gRPC server, which is used to expose the gRPC proxy
and Coherence MP metrics.</td>
</tr>
</tbody>
</table>
</div>
...
<p>So, if the version in the <code>pom.xml</code> is <code>20.06.1-SNAPSHOT</code> the image produced will be
<code>oraclecoherence/coherence-ce:20.06.1-SNAPSHOT</code></p>
...
<p>The example above would build an image named <code>foo/coherence:20.06.1-SNAPSHOT</code></p>
...
<p>By default, when started the image will run the Helidon CDI main class <code>io.helidon.microprofile.cdi.Main</code>.
This may be changed by setting the <code>COH_MAIN_CLASS</code> environment variable, for example to run <code>DefaultCacheServer</code>
add <code>-e COH_MAIN_CLASS=com.tangosol.net.DefaultCacheServer</code> to the Docker command line.</p>
...
<div class="admonition note">
<p class="admonition-inline">Not running the CDI main class will disable any functionality relying on CDI, for example MP metrics,
the Helidon web-server, gRPC server and Coherence gRPC proxy.</p>
</div>
