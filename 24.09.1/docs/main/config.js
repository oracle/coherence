...
function createRoutes(){
    return [
        ...
        },
        {
            ...
            component: loadPage('docs-about-05_api', '/docs/about/05_api', {})
        },
        {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            items: [
                                ...
                                { href: '/docs/about/05_api', title: 'API Docs' }
                            ]
                        },
                        {
                    ...
                    items: [
                        {
                            ...
                            href: 'https://oracle.github.io/coherence/24.09.1/api/java/index.html',
                            target: '_blank'
                        },
                        {
