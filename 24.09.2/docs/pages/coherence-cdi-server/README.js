...
<p>In that case, you can implement a custom <router-link to="#extractor-binding-custom" @click.native="this.scrollFix('#extractor-binding-custom')">ExtractorBinding</router-link> (recommended), or use a built-in
...
<code>ExtractorBinding</code> annotation - see the <router-link to="#extractor-binding-custom" @click.native="this.scrollFix('#extractor-binding-custom')">Custom ExtractorBinding Annotations</router-link> section below.</p>
...
See the <router-link to="#transformer-binding-custom" @click.native="this.scrollFix('#transformer-binding-custom')">Custom MapEventTransformerBinding Annotations</router-link> section below for details on how to create
...
<h4 id="transformer-binding-custom">Create the Custom Extractor Annotation</h4>
<div class="section">
<p>Creating the extractor annotation is simply creating a normal Java annotation class which is annotated with
