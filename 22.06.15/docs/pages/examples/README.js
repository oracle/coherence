...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/examples/guides/810-custom-access-controller/README"><div class="card__link-hover"/>
</router-link>
<v-card-title primary class="headline layout justify-center">
<span style="text-align:center">Certificate Based Security</span>
</v-card-title>
<v-card-text class="caption">
<p></p>
<p>This guide walks you through how to configure Coherence to use private key and certificate-based security
using a custom access controller, and custom Extend identity provider and identity asserter.</p>
</v-card-text>
</v-card>
</v-flex>
<v-flex xs12 sm4 lg3>
